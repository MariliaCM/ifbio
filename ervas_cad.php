        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action="proc_cad_ervas.php">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo $_SESSION['problema']; ?>" class="form-control" name="problema"
                      required>
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-10">
                    <input class="btn btn-primary" type="submit" name="btnCadErvas" value="Cadastrar"><br><br>
                  </div>
                </div>
