...
$btnCadPancs = filter_input(INPUT_POST, 'btnCadPancs', FILTER_SANITIZE_STRING);
if ($btnCadPancs) {
...
unset($_SESSION['nomedominio'], $_SESSION['nomereino'], $_SESSION['nomefilo'], $_SESSION['nomeclasse'], $_SESSION['nomeordem'], $_SESSION['nomefamilia'], $_SESSION['nomegenero'], $_SESSION['nomeespecie'], $_SESSION['nomeflora'], $_SESSION['usopopular'], $_SESSION['contraindicacao'], $_SESSION['uso'], $_SESSION['cultivo'], $_SESSION['parte'], $_SESSION['indicacao']);
