...
$_SESSION['usopopular'] = $usopopular;
$_SESSION['contraindicacao'] = $contraindicacao;
$_SESSION['uso'] = $uso;
$_SESSION['acao'] = $acao;
$_SESSION['indicacao'] = $indicacao;

$btnCadRelogio = filter_input(INPUT_POST, 'btnCadRelogio', FILTER_SANITIZE_STRING);
if ($btnCadRelogio) {
    ...
    INSERT INTO relogio(acao, indicacao, fkrelogio) VALUES ('$acao','$indicacao',(select idplantas from plantas, flora where fkplantas=idflora and nomeflora='" . $nomeflora . "'));";
        ...
        header("Location: relogio_cad.php?erro=1");
    }
}

unset($_SESSION['nomedominio'], $_SESSION['nomereino'], $_SESSION['nomefilo'], $_SESSION['nomeclasse'], $_SESSION['nomeordem'], $_SESSION['nomefamilia'], $_SESSION['nomegenero'], $_SESSION['nomeespecie'], $_SESSION['nomeflora'], $_SESSION['usopopular'], $_SESSION['contraindicacao'], $_SESSION['uso'], $_SESSION['cultivo'], $_SESSION['acao'], $_SESSION['indicacao']);
