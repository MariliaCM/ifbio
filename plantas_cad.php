        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action="proc_cad_plantas.php">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="inputPassword" class="col-sm-2 col-form-label">Modo de cultivo</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  <div class="col-sm-10">
                    <input class="btn btn-primary" type="submit" name="btnCadPlantas" value="Cadastrar"><br><br>
                  </div>
                </div>
