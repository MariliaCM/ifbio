                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="save_edit_masto.php">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="hidden" name="idmastofauna" value=<?php echo $idmastofauna; ?>>
