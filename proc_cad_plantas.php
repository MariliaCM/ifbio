...
$_SESSION['uso'] = $uso;
$_SESSION['cultivo'] = $cultivo;

$btnCadPlantas = filter_input(INPUT_POST, 'btnCadPlantas', FILTER_SANITIZE_STRING);
if ($btnCadPlantas) {
    ...
    if (($numero_linhasflora == 0)) {
        ...
        header("Location: plantas_cad.php?erro=1");
    }
}
unset($_SESSION['nomedominio'], $_SESSION['nomereino'], $_SESSION['nomefilo'], $_SESSION['nomeclasse'], $_SESSION['nomeordem'], $_SESSION['nomefamilia'], $_SESSION['nomegenero'], $_SESSION['nomeespecie'], $_SESSION['nomeflora'], $_SESSION['usopopular'], $_SESSION['contraindicacao'], $_SESSION['uso'], $_SESSION['cultivo']);
