                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="save_edit_relogio.php">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" value="<?php echo $acao; ?>" class="form-control" name="acao"
                                            required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-10">
                                        <input type="hidden" name="idrelogio" value=<?php echo $idrelogio; ?>>
