        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action="proc_cad_pancs.php">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" value="<?php echo $_SESSION['parte']; ?>" class="form-control" name="parte"
                      required>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <div class="col-sm-10">
                    <input class="btn btn-primary" type="submit" name="btnCadPancs" value="Cadastrar"><br><br>
                  </div>
                </div>
